...
func (*Subject_Contact) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
type Person_Name struct {
	...
	Middle    string `protobuf:"bytes,3,opt,name=middle" json:"middle,omitempty"`
	Title     string `protobuf:"bytes,4,opt,name=title" json:"title,omitempty"`
	Suffix    string `protobuf:"bytes,5,opt,name=suffix" json:"suffix,omitempty"`
	Preffered string `protobuf:"bytes,6,opt,name=preffered" json:"preffered,omitempty"`
}
...
func (*Person_Name) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1, 0} }
...
func (*Application) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
